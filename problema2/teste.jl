	...
	if adiciono == true
		...
		for l in data.id
			if ( (data.vizinhanca[j][l] == 1) | (data.vizinhanca[l][j] == 1) )
                ...
                for m in data.id
                    if ((data.vizinhanca[m][l] == 1) | (data.vizinhanca[l][m] == 1))
                        idx2 = -1 
                        ...
                        (data.vizinhanca[m][l] == 0)
                        (data.vizinhanca[l][m] == 0)
                    end
                end
				
                data.grau[idx].valor -= 1
                deleteat!(data.grau, idx)
                deleteat!(data.id, idx)
